...
export { default as CFDCompareAccountsCarousel } from './components/cfd-compare-accounts-carousel';
...
export { default as WalletCFDCard } from './components/wallet-cfd-card';
